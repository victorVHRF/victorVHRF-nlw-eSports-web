  ...
  return (
    <div className="max-w=[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <h1 className="text-6xl text-white font-black mt-20">
        Seu <span className="bg-nlw-grdient bg-clip-text text-transparent">duo</span> esta aqui.
      </h1>
      ...
      <div className="pt-1 mt-8 bg-nlw-grdient self-stretch rounded-lg overflow-hidden">
